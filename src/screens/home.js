...
import { CART, PROFILE } from "../configs";
    ...
    <SafeAreaView className="bg-white">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View className="flex flex-row justify-between h-12 items-center mb-5 mt-5">
            <TouchableOpacity className="bg-[#F5F6FA] p-4 rounded-full"  onPress={() => navigation.navigate(PROFILE)}>
          ...
          <View className="flex flex-row h-14 gap-2 mb-5">
            ...
            <TouchableOpacity  className="bg-[#9775FA] flex items-center justify-center rounded-lg px-3">
